...
if [ $# -ne 6 ]
  then
    ...
    ACCOUNT_PROVISIONER_MONITOR_API_TOKEN="${DYNAMIC_ACCOUNT_PROVISIONER_MONITOR_API_TOKEN:-$ACCOUNT_PROVISIONER_MONITOR_API_TOKEN}"
    ACCOUNT_PROVISIONER_MONITOR_API_URL=https://us2.app.sysdig.com
    ACCOUNT_PROVISIONER_SECURE_API_TOKEN="${DYNAMIC_ACCOUNT_PROVISIONER_SECURE_API_TOKEN:-$ACCOUNT_PROVISIONER_SECURE_API_TOKEN}"
    ACCOUNT_PROVISIONER_SECURE_API_URL=https://us2.app.sysdig.com
    ACCOUNT_PROVISIONER_AGENT_ACCESS_KEY="${DYNAMIC_ACCOUNT_PROVISIONER_AGENT_ACCESS_KEY:-$ACCOUNT_PROVISIONER_AGENT_ACCESS_KEY}"
